...
struct QuizneyBrain {
    ...
    let questions = [
        Question(q: "Disney California Adventure Park used to be a parking lot.",
                 a: "True",
        ...
        Question(q: "Sleeping Beauty Castle uses paint to make it look bigger than it actually is.",
                 a: "True",
        ...
        Question(q: "The Disneyland Resort has a hotel inside a theme park.",
                 a: "True",
        ...
        Question(q: "Guardians of the Galaxy — Mission: Breakout! offers six different experiences.",
                 a: "True",
        ...
        Question(q: "The Mickey Mouse floral design is replanted multiple times a year.",
                 a: "True",
        ...
        Question(q: "Only a single Mickey Mouse is present in the entire Disneyland Paris park.",
                 a: "True",
        ...
        Question(q: "The (Hyper) Space Mountain at Disneyland Paris is the fastest of the five in operation.",
                 a: "True",
        ...
        Question(q: "Main Street uses a trick called forced perspective to create the illusion of a larger space.",
                 a: "True",
        ...
        Question(q: "You can get a haircut and shave at any Disney Park.",
                 a: "True",
        ...
        Question(q: "Every Cast Member at Disneyland Paris is trained to deal with wild animals found within the park.",
                 a: "False",
        ...
        Question(q: "There’s a whole city in the undergrounds of all Disney Parks.",
                 a: "True",
        ...
        Question(q: "Main Street USA at Disneyland Paris is based on the 19th-century New Orleans.",
                 a: "False",
                 c: "The architecture of Main Street in Disneyland Paris, was inspired by Walt Disney's hometown of Marceline, Missouri."),
        Question(q: "Disneyland Paris has actual gold at its archtecture.",
                 a: "True",
        ...
        Question(q: "Every castle of all Disney Parks faces Disneyland Park in California",
                 a: "False",
        ...
        Question(q: "Rock n Roller Coaster uses the first original recordings of Aerosmith’s songs.",
                 a: "False",
        ...
        Question(q: "Walt Disney World was originally planned for St. Louis, Missouri.",
                 a: "True",
        ...
        Question(q: "Walt had an apartment at Disneyland Park.",
                 a: "True",
        ...
        Question(q: "Disneyland Park has a hidden private club.",
                 a: "True",
        ...
        Question(q: "The Pirates of the Caribbean ride has a real skull.",
                 a: "True",
        ...
        Question(q: "Guests can sleep in Cinderella's Castle.",
                 a: "True",
        ...
        Question(q: "Matterhorn Mountain has a soccer court.",
                 a: "True",
        ...
        Question(q: "The Disney World’s Railroad uses a replica of an actual train from the 1910s.",
                 a: "False",
        ...
        Question(q: "The American flags at Disney World are fake.",
                 a: "True",
        ...
        Question(q: "An estimated 1.65 million sunglasses have been lost at Disney World since it opened.",
                 a: "True",
        ...
        Question(q: "The names of the trains on Big Thunder Mountain are the names of real locomotives from the 1910’s.",
                 a: "False",
        ...
        Question(q: "Disneyland Paris’ Big Thunder Mountain landscape was inspired by Bryce Canyon in Utah.",
                 a: "False",
        ...
        Question(q: "The left one of singing busts in the graveyard scene in Disney World’s Haunted Mansion attraction is Walt Disney’s face.",
                 a: "False",
        ...
        Question(q: "The Pirates of the Caribbean Attraction at Disneyland Park was personally supervised by Walt Disney.",
                 a: "True",
        ...
        Question(q: "The water used to fill It’s a Small World Attraction in California came from the Park’s water recycling system.",
                 a: "False",
        ...
        Question(q: "The Tower of Terror’s drop is not a real drop.",
                 a: "True",
